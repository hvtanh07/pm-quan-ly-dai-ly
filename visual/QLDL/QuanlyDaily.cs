...
namespace QLDL
{
    public partial class QuanlyDaily : Form
    {
        ...
        private void loadData_Vao_GridView()
        {
            ...
            cldt.Name = "dientich";
            cldt.HeaderText = "Diện tích";
            cldt.DataPropertyName = "dientich";
            dgvBangDanhSach.Columns.Add(cldt);

            DataGridViewTextBoxColumn clsnv = new DataGridViewTextBoxColumn();
            clsnv.Name = "sonhanvien";
            clsnv.HeaderText = "Số nhân viên";
            clsnv.DataPropertyName = "sonhanvien";
            dgvBangDanhSach.Columns.Add(clsnv);           
        ...
        private void SửaĐạiLýToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (-1 < currentRowIndex && currentRowIndex < dgvBangDanhSach.RowCount)
            {
                ...
                if (hs != null)
                {
                    CapNhatSuaDaiLy frm = new CapNhatSuaDaiLy(hs);
                    frm.ShowDialog();
                }
            }
            this.loadData_Vao_GridView();
